...
Допустимый вход — document-only хеш целевой спецификации и отдельный промпт
координатора. Если переданный коммит содержит код или тесты, агент останавливается и
сообщает о нарушении изоляции, не ограничиваясь обещанием «не смотреть diff».
...
- Слепому агенту передаётся полный 40-символьный spec-хеш, а не имя ветки.
